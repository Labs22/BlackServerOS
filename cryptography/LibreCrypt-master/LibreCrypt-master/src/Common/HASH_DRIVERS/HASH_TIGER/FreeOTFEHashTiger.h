...
#ifndef _FreeOTFEHashTiger_H
#define _FreeOTFEHashTiger_H   1
...
#define DRIVER_TITLE              "Tiger"
DEFINE_GUID(DRIVER_GUID,      0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0e, 0x00, 0x01);


// NOTE: ASCII, not WCHAR
#define DRIVER_HASH_TITLE_TIGER     "Tiger"
DEFINE_GUID(HASH_GUID_TIGER,    0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0e, 0x00, 0x02);
