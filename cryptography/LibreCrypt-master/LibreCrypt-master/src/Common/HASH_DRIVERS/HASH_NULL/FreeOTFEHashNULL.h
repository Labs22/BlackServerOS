...
#ifndef _FreeOTFEHashNull_H
#define _FreeOTFEHashNull_H   1
...
// NOTE: ASCII, not WCHAR
#define DRIVER_HASH_TITLE_NULL    "Null"
DEFINE_GUID(HASH_GUID_NULL,   0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x02);
