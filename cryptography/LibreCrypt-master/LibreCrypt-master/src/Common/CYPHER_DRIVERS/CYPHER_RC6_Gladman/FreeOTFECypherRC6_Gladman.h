...
#ifndef _FreeOTFECypherRC6_Gladman_H
#define _FreeOTFECypherRC6_Gladman_H   1
...
#define DRIVER_TITLE                 "RC6 (Gladman library)"
...
DEFINE_GUID(CIPHER_GUID_RC6_128_CBC, 0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x02);

#define DRIVER_CIPHER_TITLE_RC6_192_CBC  "RC6"
DEFINE_GUID(CIPHER_GUID_RC6_192_CBC, 0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x04);

#define DRIVER_CIPHER_TITLE_RC6_256_CBC  "RC6"
DEFINE_GUID(CIPHER_GUID_RC6_256_CBC, 0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x05);

#define DRIVER_CIPHER_TITLE_RC6_128_XTS  "RC6"
DEFINE_GUID(CIPHER_GUID_RC6_128_XTS, 0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x06);

#define DRIVER_CIPHER_TITLE_RC6_192_XTS  "RC6"
DEFINE_GUID(CIPHER_GUID_RC6_192_XTS, 0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x07);

#define DRIVER_CIPHER_TITLE_RC6_256_XTS  "RC6"
DEFINE_GUID(CIPHER_GUID_RC6_256_XTS, 0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x08);


// =========================================================================
// Various internal functions

#define RC6_BLOCK_SIZE 128
