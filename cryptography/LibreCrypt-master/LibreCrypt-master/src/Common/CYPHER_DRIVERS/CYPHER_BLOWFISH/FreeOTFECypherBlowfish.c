...
#include "FreeOTFECypherBlowfish.h"
...
)
{
    ...
    FREEOTFE_MEMCPY(
                  ...
                  DRIVER_CIPHER_TITLE_BLOWFISH_448,
                  strlen(DRIVER_CIPHER_TITLE_BLOWFISH_448)
                 );

    driverInfo->CypherDetails[idx].Mode              = CYPHER_MODE_CBC;
    driverInfo->CypherDetails[idx].KeySizeUnderlying = 448;
    driverInfo->CypherDetails[idx].BlockSize         = (blowfish_desc.block_length * 8);
    driverInfo->CypherDetails[idx].VersionID         = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID        = CIPHER_GUID_BLOWFISH_448;
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_BLOWFISH_256,
                  strlen(DRIVER_CIPHER_TITLE_BLOWFISH_256)
                 );
    ...
    driverInfo->CypherDetails[idx].BlockSize         = (blowfish_desc.block_length * 8);
    driverInfo->CypherDetails[idx].VersionID         = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID        = CIPHER_GUID_BLOWFISH_256;
    driverInfo->CypherDetails[idx].KeySizeRequired   = driverInfo->CypherDetails[idx].KeySizeUnderlying;
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_BLOWFISH_192,
                  strlen(DRIVER_CIPHER_TITLE_BLOWFISH_192)
                 );
    ...
    driverInfo->CypherDetails[idx].BlockSize         = (blowfish_desc.block_length * 8);
    driverInfo->CypherDetails[idx].VersionID         = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID        = CIPHER_GUID_BLOWFISH_192;
    driverInfo->CypherDetails[idx].KeySizeRequired   = driverInfo->CypherDetails[idx].KeySizeUnderlying;
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_BLOWFISH_160,
                  strlen(DRIVER_CIPHER_TITLE_BLOWFISH_160)
                 );
    ...
    driverInfo->CypherDetails[idx].BlockSize         = (blowfish_desc.block_length * 8);
    driverInfo->CypherDetails[idx].VersionID         = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID        = CIPHER_GUID_BLOWFISH_160;
    driverInfo->CypherDetails[idx].KeySizeRequired   = driverInfo->CypherDetails[idx].KeySizeUnderlying;
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_BLOWFISH_128,
                  strlen(DRIVER_CIPHER_TITLE_BLOWFISH_128)
                 );
    ...
    driverInfo->CypherDetails[idx].BlockSize         = (blowfish_desc.block_length * 8);
    driverInfo->CypherDetails[idx].VersionID         = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID        = CIPHER_GUID_BLOWFISH_128;
    driverInfo->CypherDetails[idx].KeySizeRequired   = driverInfo->CypherDetails[idx].KeySizeUnderlying;
...
)
{
    ...
    if (!(
		  (IsEqualGUID(&CIPHER_GUID_BLOWFISH_128, CypherGUID)) || 
          (IsEqualGUID(&CIPHER_GUID_BLOWFISH_160, CypherGUID)) ||
          (IsEqualGUID(&CIPHER_GUID_BLOWFISH_192, CypherGUID)) ||
          (IsEqualGUID(&CIPHER_GUID_BLOWFISH_256, CypherGUID)) ||
          (IsEqualGUID(&CIPHER_GUID_BLOWFISH_448, CypherGUID))
		 ))
		{
...
)
{
    ...
    // Initialize cipher
    *cipher = register_cipher(&blowfish_desc);
    if (*cipher == -1)
        {
