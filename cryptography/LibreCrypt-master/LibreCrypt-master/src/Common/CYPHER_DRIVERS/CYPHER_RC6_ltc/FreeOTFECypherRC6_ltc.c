...
#include "FreeOTFECypherRC6_ltc.h"
...
)
{
    ...
    blockSizeBits = (rc6_desc.block_length * 8);
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_1024_CBC,
                  strlen(DRIVER_CIPHER_TITLE_RC6_1024_CBC)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_1024_CBC;
    DetermineCypherDetails(
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_1024_XTS,
                  strlen(DRIVER_CIPHER_TITLE_RC6_1024_XTS)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_1024_XTS;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_1024_LRW,
                  strlen(DRIVER_CIPHER_TITLE_RC6_1024_LRW)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_1024_LRW;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_256_CBC,
                  strlen(DRIVER_CIPHER_TITLE_RC6_256_CBC)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_256_CBC;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_256_XTS,
                  strlen(DRIVER_CIPHER_TITLE_RC6_256_XTS)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_256_XTS;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_256_LRW,
                  strlen(DRIVER_CIPHER_TITLE_RC6_256_LRW)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_256_LRW;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_192_CBC,
                  strlen(DRIVER_CIPHER_TITLE_RC6_192_CBC)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_192_CBC;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_192_XTS,
                  strlen(DRIVER_CIPHER_TITLE_RC6_192_XTS)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_192_XTS;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_192_LRW,
                  strlen(DRIVER_CIPHER_TITLE_RC6_192_LRW)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_192_LRW;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_128_CBC,
                  strlen(DRIVER_CIPHER_TITLE_RC6_128_CBC)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_128_CBC;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_128_XTS,
                  strlen(DRIVER_CIPHER_TITLE_RC6_128_XTS)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_128_XTS;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
    ...
    FREEOTFE_MEMCPY(
                  driverInfo->CypherDetails[idx].Title,
                  DRIVER_CIPHER_TITLE_RC6_128_LRW,
                  strlen(DRIVER_CIPHER_TITLE_RC6_128_LRW)
                 );

    driverInfo->CypherDetails[idx].BlockSize  = blockSizeBits;
    driverInfo->CypherDetails[idx].VersionID  = DRIVER_CYPHER_IMPL_VERSION;
    driverInfo->CypherDetails[idx].CypherGUID = CIPHER_GUID_RC6_128_LRW;
    DetermineCypherDetails(
                           &driverInfo->CypherDetails[idx].CypherGUID,
                           &driverInfo->CypherDetails[idx].KeySizeUnderlying,
                           &driverInfo->CypherDetails[idx].Mode
...
)
{
    ...
    if (IsEqualGUID(&CIPHER_GUID_RC6_1024_CBC, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_CBC;
        *KeySizeUnderlying = 1024;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_1024_XTS, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_XTS;
        *KeySizeUnderlying = 1024;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_1024_LRW, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_LRW;
        *KeySizeUnderlying = 1024;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_256_CBC, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_CBC;
        *KeySizeUnderlying = 256;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_256_XTS, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_XTS;
        *KeySizeUnderlying = 256;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_256_LRW, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_LRW;
        *KeySizeUnderlying = 256;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_192_CBC, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_CBC;
        *KeySizeUnderlying = 192;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_192_XTS, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_XTS;
        *KeySizeUnderlying = 192;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_192_LRW, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_LRW;
        *KeySizeUnderlying = 192;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_128_CBC, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_CBC;
        *KeySizeUnderlying = 128;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_128_XTS, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_XTS;
        *KeySizeUnderlying = 128;
        }
    else if (IsEqualGUID(&CIPHER_GUID_RC6_128_LRW, CypherGUID))
        {
        *CypherMode = CYPHER_MODE_LRW;
        *KeySizeUnderlying = 128;
        }
...
)
{
    ...
    blockSizeBytes = rc6_desc.block_length;
    ...
    if NT_SUCCESS(status) 
        ...
        switch (mode)
            ...
            case CYPHER_MODE_LRW:
                {
                if (KeyLength != (keySizeUnderlying + (rc6_desc.block_length * 8)))
                    {
                    status = STATUS_INVALID_PARAMETER;
                    }
...
)
{
    ...
    // Initialize cipher
    *cipher = register_cipher(&rc6_desc);
    if (*cipher == -1)
        {
