...
%PROJECT_DRIVE%
cd %PROJECT_DIR%\CYPHER_DRIVERS\CYPHER_DES\src
...
rem Implementation...
copy %PROJECT_BASE_DIR%\src\Common\CYPHER_DRIVERS\CYPHER_DES\FreeOTFECypherDES.c .
copy %PROJECT_BASE_DIR%\src\Common\CYPHER_DRIVERS\CYPHER_DES\FreeOTFECypherDES.h .

rem libtomcrypt library...
copy %THIRD_PARTY_DIR%\libtomcrypt\crypt-1.17\src\ciphers\des.c .
...
copy %FREEOTFE_OUTPUT_DIR%\FreeOTFECypherDES.sys %BIN_OUTPUT_DIR%
