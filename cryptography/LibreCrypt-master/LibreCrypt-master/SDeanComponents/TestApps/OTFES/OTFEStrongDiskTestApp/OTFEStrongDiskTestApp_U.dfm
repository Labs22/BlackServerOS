object OTFEStrongDiskTestApp_F: TOTFEStrongDiskTestApp_F
  Left = 253
  Top = 179
  Width = 803
  Height = 552
  Caption = 'StrongDisk Delphi Component Demo'
  Color = clBtnFace
  ...
  object OTFEStrongDisk1: TOTFEStrongDisk
    Active = False
    DefaultDrive = #0
    Left = 60
    Top = 32
