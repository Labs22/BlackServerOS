...
// -----------------------------------------------------------------------------
//
//        TOTFEScramDisk - a Delphi 32-bit component for controlling ScramDisk
//          ScramDisk - Virtual disk encryption for Windows 95/98/Me/NT/2000
//
// ScramDisk was written by Aman and is available from
// http://www.scramdisk.clara.net/
//
// The TkrScramDisk Delphi Component is ©1998 Kwik-Rite Development and was
// written by Andy Jeffries - http://www.kwikrite.clara.net/
//
// Development taken over September 1999 by Sarah Dean
...
function TOTFEScramDisk.Title(): string;
begin
  Result := 'ScramDisk';
end;
...
function TOTFEScramDisk.CanMountDevice(): boolean;
begin
  // Not supported...
  Result := TRUE;
end;
